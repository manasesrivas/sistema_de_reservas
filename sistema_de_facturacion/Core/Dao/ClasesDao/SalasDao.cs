    ...
    internal class SalasDao : Cnn, ISalasDao
    {
        ...
        public Sala? GetById(int idSalas)
        {
            ...
            try
            {
                ...
                command = new SqlCommand(@"
                    SELECT Id_Salas, Nombre, Capacidad, Disponible, Precio
                    FROM Salas
        ...
        public bool Update(Sala paSala)
        {
            try
            {
                ...
                command.Parameters.Add("@precio", SqlDbType.Decimal, 10).Value = paSala.Precio;
        ...
        public List<Sala> GetAll(string filtro = "")
        {
            ...
            {
                Con = OpenDb();
                string sql = @"SELECT Id_sala, Nombre, Capacidad, Disponible, Precio FROM Salas";
        ...
        public int Insert(Sala paSala)
        {
            try
            {
                ...
                command = new SqlCommand(@"
            INSERT INTO Salas (Nombre, Capacidad, Disponible, Precio)
            OUTPUT INSERTED.Id_Sala
            VALUES (@nombre, @capacidad, @disponible, @precio);", Con);
                ...
                command.Parameters.Add("@precio", SqlDbType.Decimal).Value = paSala.Precio;
