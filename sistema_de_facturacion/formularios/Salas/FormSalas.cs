...
namespace sistema_de_reservas.formularios.Salas
{
    public partial class FormSalas : Form
    {
        ...
        private void FormSalas_Load(object sender, EventArgs e)
        {
            ...
            if (value > 0)
            {
                ...
                if (sala != null)
                {
                    ...
                    cbDisponible.SelectedItem = sala.Disponible == 1 ? "Si" : "No";
                    numericUpDownPrecio.Value = sala.Precio;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            bool disponibleBool = cbDisponible.SelectedItem?.ToString() == "Si";

            if (string.IsNullOrEmpty(nombre) || capacidad <= 0 || numericUpDownPrecio.Value == 0)
            {
